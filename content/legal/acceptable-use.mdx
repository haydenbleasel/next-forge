...
description: This acceptable use policy covers the products, services, and technologies provided by Refraction under any ongoing agreement.
date: 2023-03-15
---

This acceptable use policy covers the products, services, and technologies (collectively referred to as the “Products”) provided by Refraction under any ongoing agreement. It’s designed to protect us, our customers, and the general Internet community from unethical, irresponsible, and illegal activity.

Refraction customers found engaging in activities prohibited by this acceptable use policy can be liable for service suspension and account termination. In extreme cases, we may be legally obliged to report such customers to the relevant authorities.

This policy was last reviewed on January 25, 2023.
...
### Unauthorized use of Refraction property

We prohibit the impersonation of Refraction, the representation of a significant business relationship with Refraction, or ownership of any Refraction property (including our Products and brand) for the purpose of fraudulently gaining service, custom, patronage, or user trust.
