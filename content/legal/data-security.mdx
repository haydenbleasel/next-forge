...
description: Refraction is committed to maintaining the confidentiality, integrity, and availability of all data processed, stored, or transmitted by our product.
date: 2023-03-16
---
...
Additionally, Refraction collects behavioural, usage and error data for improving our platform, utilising third-party products such Sentry — you can read more about their security policy on [their website](https://sentry.io/security/).
...
We take security very seriously at Refraction due to sensitivity of our customers input. We review security issues as soon as possible and you can report them by emailing [security@refraction.dev](mailto:security@refraction.dev). In case of a potential severe security incident, we're committed on informing any affected users.
