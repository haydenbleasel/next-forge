...
<Tip>
  [Languine](https://dub.sh/0KOndf7) offers two language translations and 100 keys for free. If you need more, you can upgrade to a paid plan with the discount code `nextforge` for 30% off!
</Tip>
