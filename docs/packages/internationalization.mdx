...
<Tip>
  Languine offers two languages for free. If you want to add more languages, you can upgrade to a paid plan with the discount code `nextforge` for 30% off!
</Tip>
...
This command will run automatically when you run `pnpm build`, so you don't need to worry about it.
