...
Clerk uses webhooks to handle authentication events. These are handled in the `POST /webhooks/auth` route in the `api` app. Make sure you enable the webhook events you need in your Clerk project settings.
