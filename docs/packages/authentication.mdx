...
By default, Clerk runs in Keyless mode, where Clerk generates temporary API keys for you. This is suitable for development environments.

To link your app to your Clerk project, you'll need to set the following environment variables:

```sh apps/app/.env.local
CLERK_SECRET_KEY=""
