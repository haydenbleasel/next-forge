...
The logging functionality is abstracted through a simple wrapper in `packages/observability/log.ts` that provides a consistent logging interface across environments.
