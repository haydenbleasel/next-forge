...
<Warning>
Blocked by [this issue](https://github.com/nextauthjs/next-auth/issues/11076).
</Warning>
...
## 5. Update the sign-in and sign-up components
...
type AuthProviderProps = ComponentProps<'div'>;
