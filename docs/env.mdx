...
As part of the initial setup, you will need to fill in the environment variables in the `.env.local` file. This file will be symlinked to the `.env.local` file in each Next.js application, as well as a `.env` file in the database package.
