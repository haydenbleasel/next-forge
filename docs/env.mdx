...
You also need to configure a `.env` file in the `apps/packages/database` directory. This file should be created by the setup script, so just add your `DATABASE_URL` and you should be good to go.
