...
next-forge has a pre-configured `ai` package that uses [ai-sdk](https://github.com/vercel/ai-sdk) to provide a simple interface for interacting with AI models.
