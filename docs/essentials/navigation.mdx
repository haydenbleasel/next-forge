...
## Example of Adding Recommended Libraries Page

To add the new `recommended-libraries` page to the navigation, you would update the `mint.json` file as follows:
...
"navigation": [
    {
        ...
        "pages": [
            {
                "group": "Recommended Libraries",
                "pages": [
                    "recommended-libraries/overview",
                    "recommended-libraries/zustand"
                ]
            }
        ]
    }
