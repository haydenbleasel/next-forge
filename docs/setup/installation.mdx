...
For more details on the default Prisma configuration (using Neon), refer to the [Database Configuration Guide](https://docs.next-forge.com/packages/database#default-configuration).
