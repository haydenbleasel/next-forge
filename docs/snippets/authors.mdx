          ...
          <div style={{ position: 'relative' }}>
            <div style={{ overflow: 'hidden', border: '1px solid #e5e7eb', borderRadius: '9999px', width: '2rem', height: '2rem' }}>
              <img
                ...
                src={`https://raw.githubusercontent.com/haydenbleasel/next-forge/refs/heads/main/docs/images/authors/${author.company.id}/${author.user.id}.jpg`}
                alt=""
                width={32}
                height={32}
              />
            ...
            >
              <img
                style={{ margin: 0, width: '100%', height: '100%' }}
                src={`https://raw.githubusercontent.com/haydenbleasel/next-forge/refs/heads/main/docs/images/authors/${author.company.id}/logo.jpg`}
                alt=""
                width={16}
                height={16}
              />
