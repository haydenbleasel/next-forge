...
next-forge provides a `Status` component from `@repo/status` that displays the current status of the application. You can see an example of this in the website footer.
