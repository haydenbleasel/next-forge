...
next-forge uses [Turborepo's boundaries](https://turbo.build/repo/docs/reference/boundaries) to ensure that Turborepo features work correctly by checking for package manager Workspace violations.
