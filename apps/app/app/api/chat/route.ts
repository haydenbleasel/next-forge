    ...
    messages: [
      {
        ...
        content: [
          ...
          '- 👩‍⚖️ Linting from [Ultracite](https://www.ultracite.dev/), which provides a strict set of configuration for [ESLint](https://eslint.org/), [Prettier](https://prettier.io/) and [Stylelint](https://stylelint.io/).',
