...
<Callout>We tried making this an independent package called `@repo/testing` but ran into issues with Vitest. It's possible that this will work in the future.</Callout>
