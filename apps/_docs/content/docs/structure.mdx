...
| Package | Description |
| ------- | ----------- |
| `analytics` | The analytics, which contains the analytics for the app. |
| `auth` | The authentication, which contains the authentication for the app. |
...
| `env` | The environment variables, which contains the environment variables for the app. |
...
| `tailwind-config` | The Tailwind CSS configuration, which contains the shared Tailwind CSS configuration for the app. |
