...
export const Hero: FC = () => (
  <div class="mx-2 mt-2 rounded-4xl ring-1 ring-inset ring-black/5 bg-secondary">
    <section className="container mx-auto flex max-w-5xl flex-col items-center gap-2 py-24 sm:py-32">
      ...
      <p className="mt-6 max-w-xl text-pretty text-center text-lg text-foreground/70">
