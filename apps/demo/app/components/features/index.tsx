        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:mt-16 lg:grid-cols-6 lg:grid-rows-2">
          <div className="relative lg:col-span-4">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-t-[calc(2rem+1px)] lg:rounded-tl-[calc(2rem+1px)]">
              <div className="h-80 border-b p-8 bg-secondary overflow-hidden">
                <div className="h-auto w-full border rounded-md object-cover object-left" />
              </div>
              <div className="p-10">
                ...
                <p className="mt-2 max-w-lg text-sm/6 text-muted-foreground">
                  Start building your app with a shadcn/ui template that's
                  already set up with everything you need — Tailwind, Clerk and
                  more.
                </p>
              </div>
            </div>
          ...
          <div className="relative lg:col-span-2">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-tr-[calc(2rem+1px)]">
              ...
              <div className="p-10">
                ...
                <p className="mt-2 text-lg/7 font-medium tracking-tight text-foreground"></p>
                <p className="mt-2 max-w-lg text-sm/6 text-muted-foreground">
          ...
          <div className="relative lg:col-span-4">
            ...
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-br-[calc(2rem+1px)]">
              <div className="h-80 border-b p-8 bg-secondary overflow-hidden">
                <div className="h-[120%] w-auto max-w-none border rounded-md object-cover object-left" />
              </div>
              <div className="p-10">
                <h3 className="text-sm/4 font-semibold text-muted-foreground">
                  Email
